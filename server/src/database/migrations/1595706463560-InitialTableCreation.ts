...
export class InitialTableCreation1595706463560 implements MigrationInterface {
    name = 'InitialTableCreation1595706463560'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "item" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "deleted_at" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "description" character varying NOT NULL, "sku" character varying NOT NULL, "brand" character varying, "model" character varying, "category_id" integer, CONSTRAINT "PK_d3c0c71f23e7adcf952a1d13423" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "stock_item_detail" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "deleted_at" TIMESTAMP WITH TIME ZONE, "purchase_date" TIMESTAMP WITH TIME ZONE NOT NULL, "purchase_price" numeric NOT NULL, "quantity" integer NOT NULL DEFAULT 1, "item_condition_id" integer, "stockroom_id" integer, "location_id" integer, "item_id" integer, "stock_item_listing_detail_id" integer, CONSTRAINT "REL_2a7b89a758a35fd40b9c63fb5a" UNIQUE ("stock_item_listing_detail_id"), CONSTRAINT "PK_f2a868fc1a147ddb2015b55538d" PRIMARY KEY ("id"))`, undefined);
